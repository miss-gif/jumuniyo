      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            운영 효율을 높입니다. 지역 특산물, 맛집 등 지역 기반 상품을 발굴하고
            판매하여 지역 경제 활성화에 기여합니다.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            발생 시 보험 혜택을 제공하여 배달원의 안전을 보장합니다. 배달 중 쉴
            수 있는 휴식 공간을 마련하고, 피드백 시스템을 구축하여 문제 발생 시
            신속하게 해결합니다.
          </p>
        </li>
        <li>
          <h3>지속 가능한 성장</h3>
          <p>
            주문 데이터, 배달 데이터 등을 분석하여 고객 맞춤형 서비스를 제공하고
            운영 효율을 높입니다. 빅데이터, 인공지능 등 신기술을 활용하여 새로운
            서비스를 개발하고 플랫폼 경쟁력을 강화합니다. 친환경 배달, 기부
            프로그램 등 사회적 책임을 다하는 활동을 통해 기업 이미지를 제고하고
            지속 가능한 성장을 추구합니다.
          </p>
        </li>
      </ul>
